...
if ~isempty(pool)
   ...
   switch ga.design_set
    ...
    % --- Fitness sarıcı ---
    fhandle = @(xx) compact_log_wrapper(xx, @(x) inner_fitfun(x, ga.design_set, ...
...
%                             FONKSİYONLAR
% ======================================================================
function [f, aux] = inner_fitfun(xx, design_set, obj, cons_stage, tail_sec, ...
    t_rawX, t_rawY, a_rawX, a_rawY, t_sclX, t_sclY, a_sclX, a_sclY, ...
    t5x_raw, t95x_raw, t5y_raw, t95y_raw, t5x_scl, t95x_scl, t5y_scl, t95y_scl, ...
    M, Cstr, K, n, geom, sh, orf, hyd, therm, num, cfg_stage, cache_enable, fail_early_k)
    global PARETO;
    [f, aux, PARETO] = eval_fitness_for_x(xx, design_set, ...
        obj, cons_stage, tail_sec, ...
        t_rawX, t_rawY, a_rawX, a_rawY, t_sclX, t_sclY, a_sclX, a_sclY, ...
        t5x_raw, t95x_raw, t5y_raw, t95y_raw, t5x_scl, t95x_scl, t5y_scl, t95y_scl, ...
        M, Cstr, K, n, geom, sh, orf, hyd, therm, num, cfg_stage, ...
        cache_enable, fail_early_k, PARETO);
end
